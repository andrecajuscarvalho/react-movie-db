...
const API_SEARCH = "https://api.themoviedb.org/3/search/movie?api_key=" + API_KEY + "&language=en-US&include_adult=false&query=";
  ...
  return (<>
    <header>
      <form onSubmit={actionOnSubmit}>
        <input className='search' type="search" placeholder="Movie name..." value={searchVal}
